...
typedef struct {
	...
	uint8_t roiActive;	// activate ROI
	double roiLat;	// latitude of ROI
	double roiLon;	// longitude of ROI
	double roiAlt;	// Altitude of ROI (absolut)

	float roiAngle;			// pitch angle for gimbal to center ROI
	float roiHeading;			// yaw angle for gimbal to center ROI
