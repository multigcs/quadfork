...
#define DEFAULT_CTRL_BATT_COMP      0.0f    //  0.0=off, 1.0=full
...
#define DEFAULT_MOT_PWM_FREQ	    MOTORS_PWM_FREQ
...
#define DEFAULT_COMM_BAUD4	    	115200
...
#define DEFAULT_COMM_STREAM_TYP3    COMM_STREAM_TYPE_FRSKY
